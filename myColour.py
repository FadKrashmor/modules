...
R1.3 03 Jan 23
    * A copy of the palette is returned (the palette is a list of lists)
"""
paletteDict = {"3TEST"    : [[0x00,0x80,0xF0], 
               ...
               "3DEFAULT" : [[0xA0,0x10,0x10], 
                             [0x10,0xA0,0x10],
                             [0x10,0x10,0xA0]],
               "4BL_YE"   : [[0x00,0x80,0xFF], #Blue/Yellow
                             [0x00,0x40,0xC0],
                             [0xFF,0xF0,0x00],
                             [0x00,0x00,0x80]],
               ...
               "7CAL_7"   : [[0x10,0x02,0x14], #Dark Blue
                             ...
                             [0x10,0x0C,0x78],
                             [0x10,0x0E,0x8C]],
               "7DB"      : [[0x04,0x02,0x0C], #Darker Blue
                             [0x04,0x04,0x18],
                             [0x04,0x06,0x24],
                             [0x04,0x08,0x30],
                             [0x04,0x0A,0x3C],
               ...
               "10CAL_10" : [[0x20,0x00,0x60], #Blue/Red
                             ...
                             [0x90,0x00,0x10],
                             [0x60,0x00,0x20]],
               "10DM"     : [[0x07,0x01,0x06], #Darker Magenta
                             [0x0E,0x02,0x0C],
                             [0x15,0x03,0x12],
                             [0x1C,0x04,0x18],
                             [0x23,0x05,0x1E],
...
def get_palette(name="", reqLength=3):
    ...
    if name in paletteDict:
        return paletteDict.get(name).copy()
    else:
